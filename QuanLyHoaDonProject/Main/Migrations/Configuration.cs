namespace Main.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Main.DAO.QuanLyHoaDonContext>
    {
        ...
        protected override void Seed(Main.DAO.QuanLyHoaDonContext context)
        {
            ...
            context.DonViMuaHangs.AddOrUpdate(m => m.ID, new DTO.DonViMuaHang() { ID = 1, Name = "DVM 1", DiaChiMua = "12/12/23 An dương vương", MaSoThueMua = (01245678).ToString(), STKMua = (124548451254).ToString(), SDTMua = (0123456789).ToString(), }
